...
import com.dhayanand.hackathonapp.activities.DetailActivity;
...
public class DetailWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (HackathonSyncAdapter.ACTION_DATA_UPDATED.equals(intent.getAction()) || intent.getAction().equals(AppWidgetManager.ACTION_APPWIDGET_UPDATE)) {
